...
public class ProductPrint {
    ...
    public void printProductList(List<ProductDTO> productList, SearchCondition searchCondition) {
        ...
        if(searchCondition.getOption() == "productName"){
            System.out.println("제품명 조회 : " + searchCondition.getValue());
        } else if (searchCondition.getOption() == "salesStore") {
            System.out.println("판매점 유형 조회 : " + searchCondition.getValue());
        }
