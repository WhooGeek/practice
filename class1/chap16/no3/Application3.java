...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Double> averageScoreByStudent = students.stream()
                .collect(Collectors.groupingBy(m->m.getName(), Collectors.averagingDouble(Student::getScore)));// 코드 작성
        ...
        List<String> highScorersInMath = students.stream()
                .filter(m -> m.getSubject() == "수학" && m.getScore()>=90)
                .map(Student::getName)
